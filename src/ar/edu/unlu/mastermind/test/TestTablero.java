...
class TestTablero {
	...
	//2 - Cuando se agrega una clave, 
	// automaticamente se obtiene el resultado y se le puede consultar al tablero
	@Test
	...
	@Test
	void NoSePuedeSeguirAgregandoClaversCuandoSeAdivinoLaClaveSecreta() throws Exception {
		FichaCodificadora[] miCombinacion = {FichaCodificadora.ROJO, FichaCodificadora.BLANCO,
				FichaCodificadora.AZUL,FichaCodificadora.VERDE,FichaCodificadora.NARANJA};
