...
class TestClave {
	...
	void probarQuePasarPosicionMayorACincoDaError() {
	 ...
	 void probarQueSiLaClaveTieneMasDeCincoElementosNoCargaLaClave() throws Exception {
			FichaCodificadora[] miCombinacion = {FichaCodificadora.ROJO, FichaCodificadora.BLANCO,
					FichaCodificadora.AZUL,FichaCodificadora.VERDE,FichaCodificadora.NARANJA,FichaCodificadora.NARANJA};
			miClave = new Clave(miCombinacion);	 
	 ...
	 @Test
	 void cargarManualmenteUnColoEsPosible() throws Exception {
